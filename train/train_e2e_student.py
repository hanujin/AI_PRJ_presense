...
def train_e2e_student(mode='kd', epochs=50, batch_size=2):
    device = get_device()
    TASK = 'binary' 
    print(f"🌀 E2E Student {mode} 학습 시작 (Device: {device})")
    ...
    save_path = str(save_dir / f"student_{mode}_best.pt")
...
if __name__ == "__main__":
    ...
    train_e2e_student(mode=args.mode)
